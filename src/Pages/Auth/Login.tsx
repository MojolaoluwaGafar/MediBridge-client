    ...
    <AuthLayout heading="Welcome Back" subHeading='Access your healthcare records, appointments, and care team.'>
        <form onSubmit={handleSubmit(submit)}>
            ...
            <div className="relative">
                <Input {...register("password")} className='my-2 pr-10' placeholder='Enter your password'
            ...
            <Link to="/forgotPassword"><p className="text-[#28574E] text-[18px] py-1 fontOutfit">Forgot password?</p></Link>

            <Button className='mt-8 mb-2' type="submit" content={loading ? "Signing in..." : "Sign in"} disabled={loading} />

            <Link to="/activate"><p className="text-center pt-3 fontOutfit">First time here? <span className="text-[#28574E] font-semibold">Activate Account</span></p></Link>
        </form>
    </AuthLayout>
    )
}